...
APP_NAME = "Asset Scraper Studio v19"
USER_AGENT = "Mozilla/5.0 AssetScraperStudio/19.0"
...
TR = {
    "de": {
        ...
        "about": """Asset Scraper Studio v19
...
class AssetScraperApp:
    ...
    def build_scraper_tab(self, tab):
        ...
        ttk.Label(top, text="   v19 Download Manager", style="Muted.TLabel").pack(side="left")
        ...
        ttk.Button(quick_downloads, text="SWF", command=lambda: self.download_by_type("swf")).pack(side="left", padx=3)
        ttk.Button(quick_downloads, text="AS", command=lambda: self.download_by_type("as")).pack(side="left", padx=3)
        ttk.Button(quick_downloads, text="XML", command=lambda: self.download_by_type("xml")).pack(side="left", padx=3)
        ttk.Button(quick_downloads, text="JSON", command=lambda: self.download_by_type("json")).pack(side="left", padx=3)
        ttk.Button(quick_downloads, text="JS", command=lambda: self.download_by_type("js")).pack(side="left", padx=3)
        ttk.Button(quick_downloads, text="CSS", command=lambda: self.download_by_type("css")).pack(side="left", padx=3)
    ...
    def build_about_tab(self, tab):
        ...
        ttk.Label(wrapper, text="v19 Download Manager: archive, database, repair, validation, explorer, notes, favorites, tags.", foreground=self.colors["muted"], font=("Segoe UI", self.scale_value(11))).pack(anchor="w", pady=(0, 16))
