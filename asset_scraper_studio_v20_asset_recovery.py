...
APP_NAME = "Asset Scraper Studio v20"
USER_AGENT = "Mozilla/5.0 AssetScraperStudio/20.0"
...
TR = {
    "de": {
        ...
        "about": """Asset Scraper Studio v20
...
class AssetScraperApp:
    ...
    def build_scraper_tab(self, tab):
        ...
        ttk.Label(top, text="   v20 Asset Recovery Edition", style="Muted.TLabel").pack(side="left")
        ...
        ttk.Spinbox(options, from_=0, to=100, textvariable=self.depth_var, width=5).grid(row=0, column=1, sticky="w", padx=6)
    ...
    def build_about_tab(self, tab):
        ...
        ttk.Label(wrapper, text="v20 Asset Recovery Edition: archive, database, repair, validation, explorer, notes, favorites, tags.", foreground=self.colors["muted"], font=("Segoe UI", self.scale_value(11))).pack(anchor="w", pady=(0, 16))
